...
Currently hosted on a server accessible on `http://470.iurii.io` (Is it down? Message owners of this repo!)

## About This Project
Our proposal can be found in [project-proposal-draft.md](./docs/project-proposal-draft.md)
...
You can host your own instance of the project by following instructions in [setup-instructions.md](./docs/setup-instructions.md)
